...
{ //fonction qui vérifie les Input
...
<body>
  <div id="formulaire">
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>">
      ...
      <!-- //value permet de afficher ce que l'utilisateur a tapez --> <input type="text" placeholder="Nom" name="lastname" value="<?= $lastname ?>" required>
